...
LOCAL_IMAGE="altered_datum_api"
TAG="latest"
NAMESPACE="default"
SECRET_NAME="altered-datum-api-secret"
ENV_FILE=".env"
...
function set_default_variables {
    IMAGE_NAME="altered_datum_api"
    KUBE_DEPLOYMENT="altered-datum-api-app"
    DEPLOYMENT_FILE="deployment.yaml"
}

# Function to set mac specific variables
function set_mac_variables {
    IMAGE_NAME="altered_datum_api_mac"
    KUBE_DEPLOYMENT="altered-datum-api-mac-app"
